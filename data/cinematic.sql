...
-- insert into categories(id,categoryname) values("t1","test1");
-- insert into films(id,title,des,imageurl,trailerurl)values("f1","film test","film test","filmtest.img","filmtest.com");
